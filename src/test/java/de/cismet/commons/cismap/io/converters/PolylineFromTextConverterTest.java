...
public class PolylineFromTextConverterTest {
    ...
    public void testCreateGeometry() throws Exception {
        ...
        Coordinate[] coords = new Coordinate[] { new Coordinate(1, 2), new Coordinate(3, 4), new Coordinate(5, 6) };

        Geometry result = conv.createGeometry(coords, gf);

        assertNotNull(result);
        Coordinate[] resCoords = result.getCoordinates();
        Coordinate[] expCoords = new Coordinate[] { new Coordinate(1, 2), new Coordinate(3, 4), new Coordinate(5, 6) };
