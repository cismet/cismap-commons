 ...
 *
 * <p>Java-Klasse für trkType complex type.</p>
 *
...
@XmlType(
    name = "trkType",
    propOrder = { "name", "cmt", "desc", "src", "link", "number", "type", "extensions", "trkseg" }
)
public class TrkType {
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link TrksegType }</p>
     *
     * @return  DOCUMENT ME!
     */
