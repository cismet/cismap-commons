...
public class WFSFormPOISearch extends AbstractWFSForm implements ActionListener {
    ...
    private void doSearch() {
        if (txtSearch.getText().length() >= 3) {
            ...
            lblBehind.setText(
                org.openide.util.NbBundle.getMessage(WFSFormPOISearch.class, "WFSFormPOISearch.lblBehind.text")
            ); // NOI18N
        }
    }
    ...
    private void initComponents() {
        ...
        chkVisualize.setToolTipText(
            org.openide.util.NbBundle.getMessage(WFSFormPOISearch.class, "WFSFormPOISearch.chkVisualize.toolTipText")
        ); // NOI18N
        ...
        jLabel1.setToolTipText(
            org.openide.util.NbBundle.getMessage(WFSFormPOISearch.class, "WFSFormPOISearch.jLabel1.toolTipText")
        ); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        chkLockScale.setToolTipText(
            org.openide.util.NbBundle.getMessage(WFSFormPOISearch.class, "WFSFormPOISearch.chkLockScale.toolTipText")
        ); // NOI18N
        ...
        jLabel2.setToolTipText(
            org.openide.util.NbBundle.getMessage(WFSFormPOISearch.class, "WFSFormPOISearch.jLabel2.toolTipText")
        ); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    public void actionPerformed(final ActionEvent e) {
        lblBehind.setText(
            org.openide.util.NbBundle.getMessage(
                ...
                new Object[] { cboPois.getItemCount() }
            )
        ); // NOI18N
        if (log.isDebugEnabled()) {
