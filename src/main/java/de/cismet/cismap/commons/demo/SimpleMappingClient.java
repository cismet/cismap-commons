...
public class SimpleMappingClient extends javax.swing.JFrame implements RetrievalListener {
    ...
    private void initComponents() {
        ...
        cmdShowFeatureCollection.setText(
            org.openide.util.NbBundle.getMessage(
                SimpleMappingClient.class,
                "SimpleMappingClient.cmdShowFeatureCollection.text"
            )
        ); // NOI18N
        cmdShowFeatureCollection.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        txtKZ.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.txtKZ.text")
        ); // NOI18N
        txtKZ.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        jButton1.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.jButton1.text")
        ); // NOI18N
        ...
        cmdBack.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.cmdBack.text")
        ); // NOI18N
        ...
        cmdFwd.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.cmdFwd.text")
        ); // NOI18N
        cmdFwd.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        fileMenu.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.fileMenu.text")
        ); // NOI18N

        openMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.openMenuItem.text")
        ); // NOI18N
        fileMenu.add(openMenuItem);

        saveMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.saveMenuItem.text")
        ); // NOI18N
        fileMenu.add(saveMenuItem);

        saveAsMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.saveAsMenuItem.text")
        ); // NOI18N
        fileMenu.add(saveAsMenuItem);

        exitMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.exitMenuItem.text")
        ); // NOI18N
        ...
        editMenu.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.editMenu.text")
        ); // NOI18N

        cutMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.cutMenuItem.text")
        ); // NOI18N
        editMenu.add(cutMenuItem);

        copyMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.copyMenuItem.text")
        ); // NOI18N
        editMenu.add(copyMenuItem);

        pasteMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.pasteMenuItem.text")
        ); // NOI18N
        editMenu.add(pasteMenuItem);

        deleteMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.deleteMenuItem.text")
        ); // NOI18N
        ...
        helpMenu.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.helpMenu.text")
        ); // NOI18N

        contentsMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.contentsMenuItem.text")
        ); // NOI18N
        helpMenu.add(contentsMenuItem);

        aboutMenuItem.setText(
            org.openide.util.NbBundle.getMessage(SimpleMappingClient.class, "SimpleMappingClient.aboutMenuItem.text")
        ); // NOI18N
