...
public class SearchFeature extends AbstractNewFeature implements DoubleClickableFeature {
    ...
    public Paint getFillingPaint() {
        final AbstractCreateSearchGeometryListener searchListener =
            (
                (AbstractCreateSearchGeometryListener) CismapBroker
                    .getInstance()
                    .getMappingComponent()
        ...
        return new Color(
            ...
            color.getGreen(),
            color.getBlue(),
            255 - (int) (255f * searchListener.getSearchTransparency())
        );
    }
                ...
                case RECTANGLE:
                    {
                        return org.openide.util.NbBundle.getMessage(
                            SearchFeature.class,
                            "SearchFeature.getName().searchRectangle"
                        ); // NOI18N
                    }
                case LINESTRING:
                    {
                        return org.openide.util.NbBundle.getMessage(
                            SearchFeature.class,
                            "SearchFeature.getName().searchPolyline"
                        ); // NOI18N
                    }
                case ELLIPSE:
                    {
                        return org.openide.util.NbBundle.getMessage(
                            SearchFeature.class,
                            "SearchFeature.getName().searchEllipse"
                        ); // NOI18N
                    }
                case POINT:
                    {
                        return org.openide.util.NbBundle.getMessage(
                            SearchFeature.class,
                            "SearchFeature.getName().searchPoint"
                        ); // NOI18N
                    }
                case POLYGON:
                    {
                        return org.openide.util.NbBundle.getMessage(
                            SearchFeature.class,
                            "SearchFeature.getName().searchPOLYGON"
                        ); // NOI18N
                    }
                case MULTIPOLYGON:
                    {
                        return org.openide.util.NbBundle.getMessage(
                            SearchFeature.class,
                            "SearchFeature.getName().searchMULTIPOLYGON"
                        ); // NOI18N
                    }
                default:
                    {
