...
public class ClipboardWaitDialog extends javax.swing.JDialog {
     ...
     */
    public ClipboardWaitDialog(final java.awt.Frame parent, final boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(
            new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/res/clipboard64.png"))
        ); // NOI18N

        jLabel2.setText(
            org.openide.util.NbBundle.getMessage(ClipboardWaitDialog.class, "ClipboardWaitDialog.jLabel2.text")
        ); // NOI18N
                ...
                .add(
                    layout
                        ...
                        .add(
                            layout
                                .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                .add(jProgressBar2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 227, Short.MAX_VALUE)
