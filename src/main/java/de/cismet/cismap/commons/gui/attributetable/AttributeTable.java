...
public class AttributeTable extends javax.swing.JPanel {
    ...
    private final TreeSet<DefaultFeatureServiceFeature> rejectedNewFeatures = new TreeSet<DefaultFeatureServiceFeature>();
    ...
    public AttributeTable(final AbstractFeatureService featureService) {
        ...
        final Collection<? extends AttributeTableSearchPanel> panelList = Lookup
            .getDefault()
        ...
        final Collection<? extends AttributeTableFieldCalculation> calculatorList = Lookup
            .getDefault()
                                    ...
                                    protected Object doInBackground() throws Exception {
                                        ...
                                        try {
                                            ...
                                            for (final int row : rows) {
                                                ...
                                                if (
                                                    !(
                                                        (feature instanceof PermissionProvider) &&
    ...
    private void setPartialTable(final boolean partial) {
        if (partial) {
            ...
            butSelectAll.setIcon(
                new javax.swing.ImageIcon(
                    getClass().getResource("/de/cismet/cismap/commons/gui/attributetable/res/icon-selectionadd_red.png")
                )
            );
            butInvertSelection.setIcon(
                new javax.swing.ImageIcon(
                    getClass()
                        .getResource("/de/cismet/cismap/commons/gui/attributetable/res/icon-selectionintersect_red.png")
                )
            );
            butMoveSelectedRows.setIcon(
                new javax.swing.ImageIcon(
                    getClass().getResource("/de/cismet/cismap/commons/gui/attributetable/res/icon-thissideup_red.png")
                )
            );
            butZoomToSelection.setIcon(
                new javax.swing.ImageIcon(
            ...
            butInvertSelection.setIcon(
                new javax.swing.ImageIcon(
                    getClass()
                        .getResource("/de/cismet/cismap/commons/gui/attributetable/res/icon-selectionintersect.png")
                )
            );
            butMoveSelectedRows.setIcon(
                new javax.swing.ImageIcon(
    ...
    private void setSelection(final List<? extends Feature> selectedFeatures) {
        ...
        for (int index = 0; index < tableFeatures.size(); ++index) {
            ...
            final boolean contained =
                (selectedFeatures != null) && (Collections.binarySearch(selectedFeatures, feature, featureComp) >= 0);
            ...
            for (final FeatureServiceFeature feature : clipboard) {
                ...
                if ((geomType != null) && !geomType.equals(AbstractFeatureService.UNKNOWN)) {
                    try {
                        ...
                        if (
                            (geomTypeClass != null) &&
                            ((feature.getGeometry() != null) && geomTypeClass.isInstance(feature.getGeometry()))
                        ) {
                            enabled = true;
                            break;
                        } else {
                            ...
                            try {
                                final Class otherGeomTypeClass = Class.forName(
                                    "com.vividsolutions.jts.geom." + compGeoType
                                );

                                if (
                                    (otherGeomTypeClass != null) &&
                                    (
    ...
    private void synchronizeTableSeletionWithMap() {
        ...
        final SelectionListener sl = (SelectionListener) mappingComponent
        ...
        for (int i = 0; i < selectedFeatures.length; ++i) {
            selectedFeatureIds[i] =
                model.getFeatureServiceFeature(table.convertRowIndexToModel(selectedFeatures[i])).getId();
        }
    ...
    private void loadModel(final int page) {
        ...
        final SwingWorker<List<FeatureServiceFeature>, Void> worker = new SwingWorker<List<FeatureServiceFeature>, Void>() {
            @Override
                ...
                if (pageSize != -1) {
                    ...
                    if ((keys != null) && !keys.isEmpty()) {
                        ...
                        for (final RowSorter.SortKey key : keys) {
                            ...
                            final FeatureServiceAttribute attr = (FeatureServiceAttribute) featureService
                    ...
                    featureList =
                        factory.createFeatures(
                            serviceQuery,
                            bb,
                            null,
                            (page - 1) * pageSize,
                            pageSize,
                            ((orderBy == null) ? null : orderBy.toArray(new FeatureServiceAttribute[orderBy.size()]))
                        );
                } else {
                    featureList = factory.createFeatures(serviceQuery, bb, null, 0, 0, null);
                }
            ...
            protected void done() {
                try {
                    ...
                    if (model == null) {
                        final Map<String, FeatureServiceAttribute> featureServiceAttributes = featureService.getFeatureServiceAttributes();
                        final List<String> orderedFeatureServiceAttributes = featureService.getOrderedFeatureServiceAttributes();
                        model =
                        ...
                        columnList.add(
                            NbBundle.getMessage(AttributeTable.class, "AttributeTable.loadModel.column.none")
                        );
    ...
    private void changeProcessingModeIntern(final boolean forceSave) {
        ...
        if (tbProcessing.isSelected()) {
            ...
            if (
                model.getMapServices().values().contains(featureService) &&
    ...
    private void initComponents() {
        ...
        miSortieren.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.miSortieren.text")
        ); // NOI18N
        jPopupMenu1.add(miSortieren);

        miStatistik.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.miStatistik.text")
        ); // NOI18N
        miStatistik.addActionListener(
        ...
        miSpalteAusblenden.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.miSpalteAusblenden.text")
        ); // NOI18N
        miSpalteAusblenden.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        miSpaltenUmbenennen.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.miSpaltenUmbenennen.text")
        ); // NOI18N
        miSpaltenUmbenennen.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        miFeldberechnung.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.miFeldberechnung.text")
        ); // NOI18N
        miFeldberechnung.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        mniAdvancedSorting.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.mniAdvancedSorting.text")
        ); // NOI18N
        mniAdvancedSorting.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        diaStatistic.setTitle(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.diaStatistic.title")
        ); // NOI18N
        ...
        lblCountLab.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.lblCountLab.text")
        ); // NOI18N
        ...
        lblMeanLab.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.lblMeanLab.text")
        ); // NOI18N
        ...
        lblStdDeviationLab.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.lblStdDeviationLab.text")
        ); // NOI18N
        ...
        lblNullLab.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.lblNullLab.text")
        ); // NOI18N
        ...
        diaExport.setTitle(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.diaExport.title")
        ); // NOI18N
        ...
        butCancel1.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butCancel1.text")
        ); // NOI18N
        butCancel1.setPreferredSize(new java.awt.Dimension(90, 29));
        butCancel1.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        butPrintPreview.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butPrintPreview.text")
        ); // NOI18N
        butPrintPreview.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butPrintPreview.toolTipText")
        ); // NOI18N
        ...
        butPrintPreview.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        butPrint.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butPrint.toolTipText")
        ); // NOI18N
        ...
        butExport.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butExport.toolTipText")
        ); // NOI18N
        ...
        butAttrib.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butAttrib.toolTipText")
        ); // NOI18N
        ...
        butSelectAll.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butSelectAll.text")
        ); // NOI18N
        butSelectAll.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butSelectAll.toolTipText")
        ); // NOI18N
        ...
        butInvertSelection.setIcon(
            new javax.swing.ImageIcon(
                getClass().getResource("/de/cismet/cismap/commons/gui/attributetable/res/icon-selectionintersect.png")
            )
        ); // NOI18N
        butInvertSelection.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butInvertSelection.text")
        ); // NOI18N
        butInvertSelection.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butInvertSelection.toolTipText")
        ); // NOI18N
        ...
        butInvertSelection.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        butClearSelection.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        butMoveSelectedRows.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butMoveSelectedRows.text")
        ); // NOI18N
        butMoveSelectedRows.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butMoveSelectedRows.toolTipText")
        ); // NOI18N
        ...
        butMoveSelectedRows.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        butZoomToSelection.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butZoomToSelection.text")
        ); // NOI18N
        butZoomToSelection.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butZoomToSelection.toolTipText")
        ); // NOI18N
        ...
        butZoomToSelection.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        butColWidth.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butColWidth.text")
        ); // NOI18N
        butColWidth.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butColWidth.toolTipText")
        ); // NOI18N
        ...
        butShowCols.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butShowCols.text")
        ); // NOI18N
        butShowCols.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butShowCols.toolTipText")
        ); // NOI18N
        ...
        butSearch.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butSearch.toolTipText")
        ); // NOI18N
        ...
        tbProcessing.setIcon(
            new javax.swing.ImageIcon(
                getClass().getResource("/de/cismet/cismap/commons/gui/attributetable/res/icon-edit.png")
            )
        ); // NOI18N
        tbProcessing.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.tbProcessing.toolTipText")
        ); // NOI18N
        ...
        tbProcessing.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        butUndo.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butUndo.toolTipText")
        ); // NOI18N
        ...
        butCopy.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butCopy.toolTipText")
        ); // NOI18N
        ...
        butPaste.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butPaste.toolTipText")
        ); // NOI18N
        ...
        butDelete.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.butDelete.toolTipText")
        ); // NOI18N
        ...
        btnFirstPage.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.btnFirstPage.text")
        ); // NOI18N
        btnFirstPage.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.btnFirstPage.toolTipText")
        ); // NOI18N
        ...
        btnPrevPage.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.btnPrevPage.text")
        ); // NOI18N
        btnPrevPage.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.btnPrevPage.toolTipText")
        ); // NOI18N
        btnPrevPage.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        txtCurrentPage.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.txtCurrentPage.text")
        ); // NOI18N
        txtCurrentPage.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.txtCurrentPage.toolTipText")
        ); // NOI18N
        txtCurrentPage.setMinimumSize(new java.awt.Dimension(50, 27));
        txtCurrentPage.setPreferredSize(new java.awt.Dimension(50, 27));
        txtCurrentPage.addActionListener(
            new java.awt.event.ActionListener() {
                @Override
                public void actionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        lblTotalPages.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.lblTotalPages.text")
        ); // NOI18N
        lblTotalPages.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.lblTotalPages.toolTipText")
        ); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        ...
        btnNextPage.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.btnNextPage.text")
        ); // NOI18N
        btnNextPage.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.btnNextPage.toolTipText")
        ); // NOI18N
        ...
        btnLastPage.setText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.btnLastPage.text")
        ); // NOI18N
        btnLastPage.setToolTipText(
            org.openide.util.NbBundle.getMessage(AttributeTable.class, "AttributeTable.btnLastPage.toolTipText")
        ); // NOI18N
    ...
    private void butPrintPreviewActionPerformed(final java.awt.event.ActionEvent evt) { //GEN-FIRST:event_butPrintPreviewActionPerformed
        ...
        final WaitingDialogThread<JasperPrint> wdt = new WaitingDialogThread<JasperPrint>(
            ...
            protected JasperPrint doInBackground() throws Exception {
                final JRDataSource ds =
                    (useSelectedRows ? new TableDataSource(table, selectedRows) : new TableDataSource(table));
                ...
                final DynamicReport report = new AttributeTableReportBuilder()
                    .buildReport(featureService.getName(), table);
            ...
            protected void done() {
                try {
                    ...
                    Collections.sort(
                        contributors,
                        new Comparator<JRSaveContributor>() {
                            @Override
        ...
        final WaitingDialogThread wdt = new WaitingDialogThread(
            ...
            protected Object doInBackground() throws Exception {
                ...
                for (int i = (selectedRowCount - 1); i >= 0; --i) {
                    final int index =
                        -1 * (Collections.binarySearch(ts, selectedFeatures[i].getIndex(), reverseIntComparator) + 1);
                    model.moveRowUp(selectedFeatures[i].getIndex() + (index), (i == 0));
    ...
    private void butZoomToSelectionActionPerformed(final java.awt.event.ActionEvent evt) { //GEN-FIRST:event_butZoomToSelectionActionPerformed
        ...
        final ZoomToFeaturesWorker worker = new ZoomToFeaturesWorker(
            featureList.toArray(new Feature[featureList.size()]),
            10
        );
        worker.execute();
    ...
    private void butExportActionPerformed(final java.awt.event.ActionEvent evt) { //GEN-FIRST:event_butExportActionPerformed
        if (
            (featureService.getLayerProperties().getAttributeTableRuleSet() != null) &&
     ...
     * @param  evt  DOCUMENT ME!
     */
    private void jcFormatItemStateChanged(final java.awt.event.ItemEvent evt) {} //GEN-FIRST:event_jcFormatItemStateChanged //GEN-LAST:event_jcFormatItemStateChanged
    ...
    private void butPrintActionPerformed(final java.awt.event.ActionEvent evt) { //GEN-FIRST:event_butPrintActionPerformed
        ...
        final WaitingDialogThread<JasperPrint> wdt = new WaitingDialogThread<JasperPrint>(
            StaticSwingTools.getParentFrame(this),
            true,
            NbBundle.getMessage(AttributeTable.class, "AttributeTable.butPrintActionPerformed.WaitingDialogThread"),
            null,
            500
        ) {
            @Override
    ...
    public void deleteFeatures() {
        ...
        for (final int row : selectedRows) {
            ...
            if (featureToDelete instanceof ModifiableFeature) {
                ...
                if (!(dfsf instanceof PermissionProvider) || ((PermissionProvider) dfsf).hasWritePermissions()) {
        ...
        final WaitingDialogThread<Map<Integer, String>> wdt = new WaitingDialogThread<Map<Integer, String>>(
            StaticSwingTools.getParentFrame(this),
            true,
            NbBundle.getMessage(AttributeTable.class, "AttributeTable.butDeleteActionPerformed.WaitingDialogThread"),
            null,
            500
        ) {
            @Override
                        ...
                        if (dfsf != null) {
                            try {
                                try {
                                    ...
                                    if (
                                        !(dfsf instanceof PermissionProvider) ||
    ...
    public void pasteSelectedFeaturesfromClipboard() {
        if ((clipboard != null) && featureService.isEditable()) {
            ...
            final WaitingDialogThread<List<FeatureServiceFeature>> wdt = new WaitingDialogThread<List<FeatureServiceFeature>>(
                StaticSwingTools.getParentFrame(this),
                true,
                ...
                protected List<FeatureServiceFeature> doInBackground() throws Exception {
                    ...
                    for (final FeatureServiceFeature feature : clipboard) {
                        ...
                        final String geomType = featureService
                            .getLayerProperties()
                            .getFeatureService()
                            .getGeometryType();
                        if ((geomType != null) && !geomType.equals(AbstractFeatureService.UNKNOWN)) {
                            try {
                                ...
                                if (
                                    ((geomTypeClass == null) && (feature.getGeometry() == null)) ||
                                    (
                                        (geomTypeClass != null) &&
                                        (
                                            (feature.getGeometry() != null) &&
                                    ...
                                    try {
                                        ...
                                        if (
                                            ...
                                            if (makeMulti) {
                                                replacementGeometry =
                                                    StaticGeometryFunctions.toMultiGeometry(feature.getGeometry());
                                                geometryCompatible = true;
                                            } else {
                                                replacementGeometry =
                                                    StaticGeometryFunctions.toSimpleGeometry(feature.getGeometry());
                                                geometryCompatible = true;
                                            }
                                        }
                                    } catch (ClassNotFoundException e) {
                        ...
                        if (tableRuleSet != null) {
                            ...
                            for (final String attrKey : attributeMap.keySet()) {
                                if (
                                    hasIdExpression &&
                                    featureService.getLayerProperties().getIdExpression().equalsIgnoreCase(attrKey)
                                ) {
    ...
    private void startExport(ExportDownload ed, final File file) {
        ...
        try {
            ...
            if ((outputFile == null) && (ed == null)) {
                ...
                if (
                    (geometryType == null) ||
                    geometryType.equals(AbstractFeatureService.UNKNOWN) ||
                    ...
                    if (featureGeometryType == null) {
                        outputFile =
                            StaticSwingTools.chooseFileWithMultipleFilters(
                                lastExportPath,
                                true,
                ...
                if (outputFile != null) {
                    ...
                    if (
                        !outputFile.getName().toLowerCase().endsWith("csv") &&
                ...
                if (outputFile != null) {
                    ...
                    if (
                        !ed.getClass().getName().toLowerCase().contains("csv") &&
    ...
    public boolean saveChangedRows(final boolean forceSave, final boolean changeProcessingMode) {
        ...
        if (
            !save &&
            (!modifiedFeatures.isEmpty() || featureDeleted || !newFeatures.isEmpty() || !lockedFeatures.isEmpty())
        ) {
            final int ans = JOptionPane.showConfirmDialog(
                AttributeTable.this,
                NbBundle.getMessage(
        ...
        if (save) {
            ...
            if (tableRuleSet instanceof AttributeTableExtendedRuleSet) {
                ...
                if (details != null) {
                    if (details.getFeature() != null) {
                        final int featureIndex = table.convertRowIndexToView(
                            model.getRowByFeature(details.getFeature())
                        );
            ...
            } else if ((tableRuleSet != null) && !tableRuleSet.prepareForSave(featuresPrepareForSave)) {
                tbProcessing.setSelected(true);
                return false;
            }
                    ...
                    if (featureService instanceof ShapeFileFeatureService) {
                        ...
                        try {
                            if ((features.size() > 0)) {
                                ...
                                final ShapeFile shape = new ShapeFile(fc, filename);
    ...
    private void setTableSize() {
        ...
        for (int i = 0; i < columnCount; ++i) {
            ...
            for (int row = 0; (row < model.getRowCount()) && (row < 50); ++row) {
                final int tmpSize = (int) fmetrics
                    .getStringBounds(String.valueOf(model.getValueAt(row, i)), table.getGraphics())
                    .getWidth();
    ...
    public void unlockAll() {
        ...
        if (!allLocksRemoved) {
            JOptionPane.showMessageDialog(
                AttributeTable.this,
                NbBundle.getMessage(AttributeTable.class, "AttributeTable.CustomTableModel.setEditable.message"),
                NbBundle.getMessage(AttributeTable.class, "AttributeTable.CustomTableModel.setEditable.title"),
                JOptionPane.ERROR_MESSAGE
            );
        }
    ...
    private class CustomTableModel extends SimpleAttributeTableModel implements PropertyChangeListener {
        ...
        public void setValueAt(final Object aValue, final int rowIndex, final int columnIndex) {
            ...
            if (tableRuleSet != null) {
                newObject =
                    tableRuleSet.afterEdit(feature, attrName, rowIndex, feature.getProperty(attrName), newObject);
            }
    ...
    private class CustomColorHighlighter extends org.jdesktop.swingx.decorator.ColorHighlighter {
        ...
        protected void applyForeground(final Component renderer, final ComponentAdapter adapter) {
            ...
            if (tbProcessing.isSelected()) {
                ...
                final FeatureServiceFeature f = model.getFeatureServiceFeature(
                    table.convertRowIndexToModel(adapter.row)
                );
