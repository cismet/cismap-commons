...
//        prbLayer.setBorderPainted(false);
    ...
    private void initComponents() {
        ...
        lblLayerName.setText("Verdis Layer");
            ...
            public void run() {
                if (getLayer().isEnabled()) {
                    if (e.getRetrievedObject() instanceof Image) {
                        ...
                        errorImage=bi;
                        slider.setToolTipText("Der Server lieferte ein Fehlerbild zur�ck:");
...
//                  slider.setToolTipText("<html><b>Der Server lieferte folgende Fehlermeldung zur�ck:<br></b><body>"+message+"</body></html>");
                        SwingUtilities.invokeLater(new Runnable() {
                            public void run() {
                                slider.setToolTipText("<html><table width=310 border=\"0\"><tr><th align=\"left\"><b>Der Server lieferte folgende Fehlermeldung zur�ck:</th></tr><tr><td>"+message+"</td></tr></table></html>");
                            }
                        });
