...
public class SearchOptionsPanel extends AbstractOptionsPanel implements OptionsPanelController {
    ...
    private static final String CONF_GEOMETRY_TRANSPARENCY = "GeometryTransparency";//NOI18N
    ...
    public void configure(Element parent) {
        if (!stillConfigured) {
            log.debug("Configure SearchOptionsPanel");//NOI18N
            try {
                String elementHoldGeometries = "";//NOI18N
                String elementGeometryColor = "";//NOI18N
                String elementGeometryTransparency = "";//NOI18N
                if (parent != null) {
                ...
                log.error("Error during the configuration of the SearchOptionsPanel", ex);//NOI18N
            }
            ...
            log.debug("skip Configure SearchOptionsPanel - still configured");//NOI18N
        }
    ...
    private void setColor(Color newColor) {
        log.debug("newColor: " + newColor);//NOI18N
