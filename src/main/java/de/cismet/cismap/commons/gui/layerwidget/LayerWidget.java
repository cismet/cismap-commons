...
public class LayerWidget extends JPanel implements DropTargetListener, Configurable {
    ...
    public LayerWidget(MappingComponent mapC) {
        ...
        initComponents();
        this.mapC = mapC;
        log.info("LayerWidget: " + activeLayerModel);
...
//                treeTable.repaint();
    ...
    private void initComponents() {
        ...
        cmdTreeCollapse.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/layerwidget/res/collapseTree.png")));
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle"); // NOI18N
        cmdTreeCollapse.setToolTipText(bundle.getString("LayerWidget.cmdTreeCollapse.toolTipText")); // NOI18N
        ...
        cmdRefreshSingleLayer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/layerwidget/res/refresh.png")));
        cmdRefreshSingleLayer.setToolTipText(bundle.getString("LayerWidget.cmdRefreshSingleLayer.toolTipText")); // NOI18N
        ...
        cmdDown.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/layerwidget/res/down.png")));
        cmdDown.setToolTipText(bundle.getString("LayerWidget.cmdDown.toolTipText")); // NOI18N
        ...
        cmdUp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/layerwidget/res/up.png")));
        cmdUp.setToolTipText(bundle.getString("LayerWidget.cmdUp.toolTipText")); // NOI18N
        ...
        cmdZoomToFullExtent.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/layerwidget/res/layerZoom.png")));
        cmdZoomToFullExtent.setMargin(new java.awt.Insets(2, 1, 2, 1));
        jToolBar1.add(cmdZoomToFullExtent);

        cmdDisable.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/layerwidget/res/disable.png")));
        cmdDisable.setToolTipText(bundle.getString("LayerWidget.cmdDisable.toolTipText")); // NOI18N
        ...
        cmdRemove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/layerwidget/res/removeLayer.png")));
        cmdRemove.setToolTipText(bundle.getString("LayerWidget.cmdRemove.toolTipText")); // NOI18N
        ...
        cmdMakeInvisible.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/layerwidget/res/layerDLinvisible.png")));
        cmdMakeInvisible.setToolTipText(bundle.getString("LayerWidget.cmdMakeInvisible.toolTipText")); // NOI18N
    ...
    private void cmdRefreshSingleLayerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdRefreshSingleLayerActionPerformed
        ...
        if (EventQueue.isDispatchThread()){log.fatal("InvokeLater in EDT");}
    ...
    public void drop(final java.awt.dnd.DropTargetDropEvent dtde) {
        ...
        log.debug("Drop mit diesen Flavours:" + dtde.getCurrentDataFlavorsAsList());
        if (dtde.isDataFlavorSupported(DataFlavor.javaFileListFlavor) || dtde.isDataFlavorSupported(DnDUtils.URI_LIST_FLAVOR)) {
            ...
            try {
                ...
                if (dtde.isDataFlavorSupported(DnDUtils.URI_LIST_FLAVOR)) {
                    ...
                    if (dtde.isDataFlavorSupported(DnDUtils.URI_LIST_FLAVOR)) {
                        log.debug("Drop is unix drop xxx " + transferable.getTransferData(DataFlavor.javaFileListFlavor));

                        data = DnDUtils.textURIListToFileList((String) transferable.getTransferData(DnDUtils.URI_LIST_FLAVOR));
                    } else {
                        log.debug("Drop is windows drop");
                        data = (java.util.List) transferable.getTransferData(DataFlavor.javaFileListFlavor);
                    }
                }
                log.debug("Drag&Drop File List: " + data);
                if (data != null) {
                    for (File currentFile : data) {
                        //NO HARDCODING
                        try {
                            log.info("DocumentUri: " + currentFile.toURI());
                            ...
                            log.error("Fehler beim anlegen eines FeatureServices", ex);
                        }
                    }
                } else {
                    log.warn("Keine Dateien vorhanden");
                }
            } catch (Exception ex) {
                log.error("Failure during drag & drop opertation", ex);
            }
        } else if (dtde.isDataFlavorSupported(TREEPATH_FLAVOR)) {
            try {
                log.debug(java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle").getString("LayerWidget.log.Es_gibt") + dtde.getTransferable().getTransferDataFlavors().length + java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle").getString("LayerWidget.log.DataFlavours"));
                ...
                JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this), java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle").getString("LayerWidget.LayerAlreadyExists"), java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle").getString("LayerWidget.AddLayer"), JOptionPane.ERROR_MESSAGE);
            } catch (Exception e) {
                log.error(e, e);
            }
        } else {
            log.warn("No Matching dataFlavour: " + dtde.getCurrentDataFlavorsAsList());
        }
    }
    ...
    public static Vector<String> getCapabilities(Element e, Vector<String> v) {
        try {
            if (e.getName().equals("capabilities") && e.getAttribute("type") != null && (e.getAttribute("type").getValue().equals(CapabilityLink.OGC) || e.getAttribute("type").getValue().equals(CapabilityLink.OGC_DEPRECATED))) {
