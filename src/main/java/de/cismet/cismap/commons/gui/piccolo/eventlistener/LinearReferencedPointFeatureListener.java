...
public interface LinearReferencedPointFeatureListener {
     ...
     */
    void featureMoved(LinearReferencedPointFeature pointFeature);
     ...
     */
    void featureMerged(LinearReferencedPointFeature withPoint, LinearReferencedPointFeature mergePoint);
}
