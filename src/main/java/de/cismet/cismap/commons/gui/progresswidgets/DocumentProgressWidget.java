...
public class DocumentProgressWidget  extends javax.swing.JInternalFrame
{
  ...
  public DocumentProgressWidget()
  {
    ...
    {
      logger.error("Fehler beim Entfernen von Mousemotionlisteners", e);//NOI18N
    }
  ...
  {
    logger.debug("setting progress: " + progress);//NOI18N
    if(progress == -1)
    {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        messageLabel.setText(org.openide.util.NbBundle.getMessage(DocumentProgressWidget.class, "DocumentProgressWidget.messageLabel")); // NOI18N
