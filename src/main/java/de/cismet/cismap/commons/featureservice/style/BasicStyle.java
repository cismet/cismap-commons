...
public class BasicStyle implements Style
{
  ...
  public void setPointSymbolSize(int pointSymbolSize)
  {
    ...
    {
      logger.warn("pointSymbolSize " + pointSymbolSize + " smaller than MIN_POINTSYMBOLSIZE " + MIN_POINTSYMBOLSIZE + ", settign to MIN_POINTSYMBOLSIZE");//NOI18N
      this.pointSymbolSize = MIN_POINTSYMBOLSIZE;
    }
    else if(pointSymbolSize > Style.MAX_POINTSYMBOLSIZE)
    {
      logger.warn("pointSymbolSize " + pointSymbolSize + " lager than MAX_POINTSYMBOLSIZE " + MAX_POINTSYMBOLSIZE + ", settign to MAX_POINTSYMBOLSIZE");//NOI18N
  ...
  public void initFromElement(Element element) throws Exception
  {
    ...
    {
      logger.warn("the element '"+element.getName()+"' is no valid style element, '" + Style.STYLE_ELEMENT + "' expected");//NOI18N
    }
  }
