...
public class PrintingSettingsWidget extends javax.swing.JDialog implements Configurable {
    ...
    private void initComponents() {
        ...
        setTitle(GuiBundle.getString("PrintingSettingsWidget.Form.title")); // NOI18N
        panDesc.setBackground(java.awt.SystemColor.inactiveCaptionText);
        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel1.setText(GuiBundle.getString("PrintingSettingsWidget.jLabel1.text_1")); // NOI18N
        jLabel2.setText(GuiBundle.getString("PrintingSettingsWidget.jLabel2.text_1")); // NOI18N
        jLabel3.setText(GuiBundle.getString("PrintingSettingsWidget.jLabel3.text_1")); // NOI18N
        jLabel4.setText(GuiBundle.getString("PrintingSettingsWidget.jLabel4.text_1")); // NOI18N
        ...
        cmdOk.setMnemonic('O');
        cmdOk.setText(GuiBundle.getString("PrintingSettingsWidget.cmdOk.text")); // NOI18N
        ...
        cmdCancel.setText(GuiBundle.getString("PrintingSettingsWidget.cmdCancel.text")); // NOI18N
        ...
        jLabel6.setText(GuiBundle.getString("PrintingSettingsWidget.jLabel6.text_1")); // NOI18N
        jLabel7.setText(GuiBundle.getString("PrintingSettingsWidget.jLabel7.text_1")); // NOI18N
        jLabel8.setText(GuiBundle.getString("PrintingSettingsWidget.jLabel8.text_1")); // NOI18N
        jLabel9.setText(GuiBundle.getString("PrintingSettingsWidget.jLabel9.text_1")); // NOI18N
        jLabel10.setText(GuiBundle.getString("PrintingSettingsWidget.jLabel10.text_1")); // NOI18N
        cboTemplates.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cboScales.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cboScales.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboScalesActionPerformed(evt);
            }
        });
        cboResolution.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cboAction.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        org.jdesktop.layout.GroupLayout panSettingsLayout = new org.jdesktop.layout.GroupLayout(panSettings);
        panSettings.setLayout(panSettingsLayout);
        panSettingsLayout.setHorizontalGroup(
            panSettingsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(panSettingsLayout.createSequentialGroup()
                .addContainerGap()
                .add(panSettingsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(panSettingsLayout.createSequentialGroup()
                        .add(jLabel6)
                        .add(14, 14, 14))
                    .add(panSettingsLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(panSettingsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(cboAction, 0, 224, Short.MAX_VALUE)
                            .add(cboResolution, 0, 224, Short.MAX_VALUE)
                            .add(cboScales, 0, 224, Short.MAX_VALUE)
                            .add(cboTemplates, 0, 224, Short.MAX_VALUE))))
                .addContainerGap())
            .add(jSeparator4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 296, Short.MAX_VALUE)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, panSettingsLayout.createSequentialGroup()
                .addContainerGap()
        ...
        panSettingsLayout.setVerticalGroup(
            ...
            .add(panSettingsLayout.createSequentialGroup()
                ...
                .add(panSettingsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel7)
                    .add(cboTemplates, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(panSettingsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel8)
                    .add(cboScales, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(panSettingsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel9)
                    .add(cboResolution, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(panSettingsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel10)
            ...
            .add(layout.createSequentialGroup()
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        ...
                        .add(panSettings, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(panSettings, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, panDesc, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
    ...
    private void cmdOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOkActionPerformed
        try {
            ...
            Scale selectedScale = (Scale) cboScales.getSelectedItem();
            Resolution selectedResolution = (Resolution) cboResolution.getSelectedItem();
            mappingComponent.setPrintingResolution(selectedResolution.getResolution() / FEATURE_RESOLUTION_FACTOR);
            Template selectedTemplate = (Template) cboTemplates.getSelectedItem();
            mappingComponent.setInteractionMode(MappingComponent.PRINTING_AREA_SELECTION);
    ...
    private void cboScalesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboScalesActionPerformed
    ...
    public void masterConfigure(Element parent) {
        try {
            Element prefs = parent.getChild("printing");//NOI18N
            configuration = (Element) prefs.clone();
            List scalesList = prefs.getChildren("scale");//NOI18N
            List resolutionsList = prefs.getChildren("resolution");//NOI18N
            List templatesList = prefs.getChildren("template");//NOI18N
            List actionList = prefs.getChildren("action");//NOI18N
