...
public class PrintingWidget extends javax.swing.JDialog implements RetrievalListener
{
   ...
   */
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle GuiBundle = java.util.ResourceBundle.getBundle("de/cismet/cismap/commons/GuiBundle"); // NOI18N
        lbl1.setText(GuiBundle.getString("PrintingWidget.lbl1.text")); // NOI18N
        txt1.setText(GuiBundle.getString("PrintingWidget.txt1.text")); // NOI18N
        lbl2.setText(GuiBundle.getString("PrintingWidget.lbl2.text")); // NOI18N
        txt2.setText(GuiBundle.getString("PrintingWidget.txt2.text")); // NOI18N

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle(GuiBundle.getString("PrintingWidget.Form.title")); // NOI18N
        ...
        jLabel1.setText(GuiBundle.getString("PrintingWidget.jLabel1.text")); // NOI18N

        jLabel2.setText(GuiBundle.getString("PrintingWidget.jLabel2.text")); // NOI18N

        jLabel3.setText(GuiBundle.getString("PrintingWidget.jLabel3.text")); // NOI18N

        jLabel4.setText(GuiBundle.getString("PrintingWidget.jLabel6.text")); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cismap/commons/gui/res/frameprint.png")));
        ...
        panDescLayout.setHorizontalGroup(
            ...
            .add(jSeparator3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
            ...
            .add(panDescLayout.createSequentialGroup()
                ...
                .add(panDescLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(panDescLayout.createSequentialGroup()
                        .add(jSeparator2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                        .addContainerGap())
                    .add(panDescLayout.createSequentialGroup()
                        .add(panDescLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jLabel1)
        ...
        cmdOk.setMnemonic('O');
        cmdOk.setText(GuiBundle.getString("PrintingWidget.cmdOk.text")); // NOI18N
        ...
        cmdCancel.setText(GuiBundle.getString("PrintingWidget.cmdCancel.text")); // NOI18N
        ...
        jLabel6.setText(GuiBundle.getString("PrintingWidget.jLabel6.text")); // NOI18N
        ...
        panProgressLayout.setHorizontalGroup(
            ...
            .add(prbLoading, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
            .add(scpLoadingStatus, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
        );
        ...
        panLoadAndInscribeLayout.setHorizontalGroup(
            ...
            .add(panLoadAndInscribeLayout.createSequentialGroup()
                ...
                .add(jLabel6)
                .add(148, 148, 148))
            .add(jSeparator4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 350, Short.MAX_VALUE)
            .add(panLoadAndInscribeLayout.createSequentialGroup()
                .addContainerGap()
            ...
            .add(panLoadAndInscribeLayout.createSequentialGroup()
                .addContainerGap()
                .add(panInscribe, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                .addContainerGap())
        );
        panLoadAndInscribeLayout.setVerticalGroup(
            ...
            .add(panLoadAndInscribeLayout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(panInscribe, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        cmdBack.setText(GuiBundle.getString("PrintingWidget.cmdBack.text")); // NOI18N
